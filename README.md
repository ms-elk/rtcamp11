...
## Build
Follow the [build instruction](https://github.com/ms-elk/alpine/tree/5ef8137389fc06edad3ddcd65a879ebe9dd43886?tab=readme-ov-file#build-instructions) of `alpine`, but run CMake in the root directory of `rtcamp11` instead of `alpine`.
